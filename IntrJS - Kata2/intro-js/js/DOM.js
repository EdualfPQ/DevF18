const productList = [
  ...
  },
  {
    ...
    precio: 10,
    cantidad: 10,
    descripcion: 'Bebida hidratante 1',
    imagen: 'https://via.placeholder.com/200',
    ml: 100,
  },
]
...
const buildSelectList = (productList) => {
    const select = document.getElementById('select')
    productList.forEach((element) => {
        const createOption = document.createElement('option');  
        createOption.setAttribute('value', element.id); //<option value="nombre"></option>
        createOption.innerHTML = `${element.nombre}`;
